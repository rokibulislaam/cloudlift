...
def mock_get_region_for_environment(request, monkeypatch):
    ...
    - Can be parameterized to return a custom region using `pytest.mark.parametrize`.

    Example:
        @pytest.mark.parametrize("mock_get_region_for_environment", ["us-west-2"], indirect=True)
